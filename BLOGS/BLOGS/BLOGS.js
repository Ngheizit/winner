...
window.onload = function(){
    var blogList = [
        createBlogObjext("图形面积的计算 - 坐标解析法", "利用编程语言实现坐标解析法计算二维图形面积", ["面积度量", "二维平面", "JavaScript"], "./date/2019-6-18/index.html", emoticons[randomNum(0, emoticons.length-1)], "2019年6月18日"),
